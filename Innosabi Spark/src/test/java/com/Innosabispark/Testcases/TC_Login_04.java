...
public class TC_Login_04 extends BasePage{
	WebDriver driver;
	...
	public void setUp() throws InterruptedException {
		...
		extent = new ExtentReports("C:\\eclipse-workspace\\AutomationReports\\ExtentReports("+fileName+"TC_Login_04).html");
	...
	public void verifyLogin_03() throws InterruptedException {
		...
		test.log(LogStatus.PASS,"Entered invalid email address");
		lp.next();
		...
		test.log(LogStatus.PASS," Successfully Displayed Login Failed message while trying to login with Invalid email");
