...
public class TC_SearchTest_06 extends BasePage{
	...
	public void setUp() throws InterruptedException {
		...
		extent = new ExtentReports("C:\\eclipse-workspace\\AutomationReports\\ExtentReports("+fileName+"TC_SearchTest_06).html");
	...
	public void TearDown(ITestResult Result) throws IOException {
		...
		if(Result.getStatus()==ITestResult.SUCCESS) {
			String screenshotpath=getScreenshot(driver, Result.getName(),"TC6");
		...
		if(Result.getStatus()==ITestResult.FAILURE) {
			String screenshotpath1=getScreenshot(driver, Result.getName(),"TC6");
